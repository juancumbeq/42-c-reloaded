...
/* Create a function that displays the alphabet in lowercase, on a sigle line, by ascending 
 * order, starting from the letter 'a'. */

/* Here is how is should be prototyped: void ft_print_alphabet(c)*/
